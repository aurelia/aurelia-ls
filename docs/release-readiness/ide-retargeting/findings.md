...
|---|---|---|---|---|---|---|
| F-FND-001 | WS01 | release-blocker | open | CP1 | Cohort-planner semantic contract is deterministically red; implementation and invariant disagree. | `template-compilation-cohort-planner.test.ts:93`; adjudicate owner-resource lookup policy. |
| F-FND-002 | WS01 | release-blocker | open | CP1 | Bidirectional suffix matching can choose a longer nested path over an exact requested path. | `source-address.ts:186`; `runtime.ts:7177`; add exact/ambiguous collision canary. |
| F-FND-003 | WS01 | high | open | CP1 | Same-handle field provenance may grant false field-specific precision on generated or derived products. | Audit current Atlas fan-out rows and downstream edit/diagnostic consumers. |
