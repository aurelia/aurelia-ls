...
- If a commit lands several coequal changes and there is no single unifying capability, name more than one of them in the subject. Commas and `and` are fine.
