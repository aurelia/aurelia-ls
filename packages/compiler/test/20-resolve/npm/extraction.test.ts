...
import type { AnalysisResult, PackageAnalysis } from '../../../src/analysis/20-resolve/resolution/npm/index.js';
...
describe('npm extraction', () => {
  ...
  describe('simple-decorated fixture', () => {
    ...
    it('detects package as Aurelia-related', async () => {
      const { isAureliaPackage } = await import('../../../src/analysis/20-resolve/resolution/npm/index.js');
