...
import { BUILTIN_SEMANTICS, prepareProjectSemantics } from "../../out/schema/registry.js";
...
import type { CustomElementDef } from "../../out/schema/types.js";
import type { DOMNode, TemplateIR } from "../../out/model/ir.js";
import type { NodeId, TemplateId } from "../../out/model/identity.js";
...
function createShadowHostSemantics() {
  return createSemanticsWithElements([createElementDef("shadow-host", true)]);
}

function createProjectionHostSemantics() {
  return createSemanticsWithElements([createElementDef("my-card", false)]);
}
