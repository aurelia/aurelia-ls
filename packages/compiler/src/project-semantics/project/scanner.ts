...
export function createProjectScanner(
  ...
  function scanSourceFiles(): ProjectFile[] {
    ...
    return trace.span("scanner.source", () => {
      debug.project("scanner.source.start", { patterns: opts.sourcePatterns });
      ...
      debug.project("scanner.source.done", { count: files.length });
  ...
  function scanTemplateFiles(): ProjectFile[] {
    ...
    return trace.span("scanner.template", () => {
      debug.project("scanner.template.start", { patterns: opts.templatePatterns });
      ...
      debug.project("scanner.template.done", { count: files.length });
  ...
  function scanStylesheetFiles(): ProjectFile[] {
    ...
    return trace.span("scanner.stylesheet", () => {
      debug.project("scanner.stylesheet.start", {});
      ...
      debug.project("scanner.stylesheet.done", { count: files.length });
  ...
  function computeFilePairs(): FilePair[] {
    ...
    return trace.span("scanner.pairs", () => {
      debug.project("scanner.pairs.start", {});
      ...
      debug.project("scanner.pairs.done", {
        total: pairs.length,
        withTemplate,
        withStylesheet,
      });
  ...
  function computeConventionMatches(): Map<NormalizedPath, DirectoryMatch> {
    ...
    return trace.span("scanner.conventions", () => {
      debug.project("scanner.conventions.start", { count: opts.conventions.length });
      ...
      debug.project("scanner.conventions.done", { matchCount: matches.size });
  ...
  function computeOrphans(): { orphanTemplates: ProjectFile[]; sourcesWithoutTemplates: ProjectFile[] } {
    ...
    return trace.span("scanner.orphans", () => {
      debug.project("scanner.orphans.start", {});
      ...
      debug.project("scanner.orphans.done", {
