...
import { fullyResolve } from '../../evaluate/value/resolve.js';
...
export function analyzeFactoryCall(
  ...
  debug.project('factory.analyzeCall', {
  ...
  if (!functionDef) {
    debug.project('factory.noFunction', {
  ...
  debug.project('factory.foundFunction', {
