...
import type { FileFacts, FileContext } from "./21-extract/file-facts.js";
import type { AnalysisGap } from "./23-partial-eval/types.js";
import type { DefineMap } from "./defines.js";
import type { RegistrationAnalysis, RegistrationSite, RegistrationEvidence } from "./26-registration/types.js";
import type { ConventionConfig } from "./conventions/types.js";
import type { Logger } from "./types.js";
import type { FileSystemContext } from "./project/context.js";
import { extractAllFileFacts, extractFileContext } from "./21-extract/file-facts-extractor.js";
import { evaluateFileFacts } from "./23-partial-eval/index.js";
import { buildExportBindingMap } from "./22-export-bind/export-resolver.js";
import { matchFileFacts } from "./24-patterns/pipeline.js";
import { createRegistrationAnalyzer } from "./26-registration/analyzer.js";
import { buildResourceGraph } from "./27-graph/builder.js";
...
import { buildSemanticsArtifacts } from "./25-semantics/build.js";
import { stripSourcedNodes } from "./25-semantics/strip.js";
import { discoverTemplates } from "./29-templates/index.js";
import type { InlineTemplateInfo, TemplateInfo } from "./29-templates/types.js";
import { buildApiSurfaceSnapshot, buildSemanticSnapshot } from "./28-snapshots/index.js";

export type { InlineTemplateInfo, TemplateInfo } from "./29-templates/types.js";
