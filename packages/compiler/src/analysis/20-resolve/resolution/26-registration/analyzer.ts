...
import type { FileFacts, FileContext, ImportDeclaration, RegistrationCall, TemplateImport } from "../21-extract/file-facts.js";
import type { ClassValue, AnalyzableValue } from "../23-partial-eval/value/types.js";
import { extractStringArrayProp, getProperty } from "../23-partial-eval/value/types.js";
import type { ExportBindingMap } from "../22-export-bind/types.js";
import { lookupExportBinding } from "../22-export-bind/export-resolver.js";
