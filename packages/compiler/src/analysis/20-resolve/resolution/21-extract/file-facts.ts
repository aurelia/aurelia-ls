...
import type { ClassValue, LexicalScope, AnalyzableValue, ResolutionContext } from '../23-partial-eval/value/types.js';
 ...
 */
export type { ResolutionContext } from '../23-partial-eval/value/types.js';
