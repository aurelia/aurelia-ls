...
import { extractAllFileFacts } from '../21-extract/file-facts-extractor.js';
import { matchDecorator } from '../24-patterns/decorator.js';
import { matchStaticAu } from '../24-patterns/static-au.js';
import { matchConvention } from '../24-patterns/convention.js';
import { matchDefine } from '../24-patterns/define.js';
import { canonicalPath } from '../util/naming.js';
import type { FileFacts, FileContext, DefineCall } from '../21-extract/file-facts.js';
...
import {
  ...
  type LexicalScope,
  type ClassValue,
} from '../23-partial-eval/value/index.js';
...
import { sourcedValue, unwrapSourced } from '../25-semantics/sourced.js';
