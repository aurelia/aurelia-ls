...
import type { ClassValue, LexicalScope, AnalyzableValue } from '../23-partial-eval/value/types.js';
import type { AnalysisGap } from '../23-partial-eval/types.js';
import { gap } from '../23-partial-eval/types.js';
import { extractClassValue } from '../23-partial-eval/value/class-extraction.js';
import { buildFileScope } from '../23-partial-eval/value/scope.js';
import { transformExpression } from '../23-partial-eval/value/transform.js';
...
export function extractAllFileFacts(
  ...
  debug.resolution('fileFacts.extractAll.start', {
  ...
  debug.resolution('fileFacts.extractAll.done', {
...
function detectSiblingFiles(
  ...
  debug.resolution('fileFacts.siblings', {
    sourcePath,
...
function extractSiblingTemplateImports(
  ...
  debug.resolution('fileFacts.templateImports', {
