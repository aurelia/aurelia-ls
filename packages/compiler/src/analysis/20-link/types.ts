// Linked forms produced by the Link phase (IR → LinkModule).
...
/* ===========================
 * Diagnostics (Link phase)
 * =========================== */

/**
 * Link phase diagnostic codes (canonical catalog).
 */
export type SemDiagCode = DiagnosticCodeForStage<"link">;

export type SemDiagnostic = CompilerDiagnostic<SemDiagCode, DiagnosticDataFor<SemDiagCode>>;

/* ===========================
 * Link module / template / row
 * =========================== */
