 ...
 *
 * This replaces the previous `RegistrationIntent[]` with a richer model that:
 ...
 * All variants include source location for diagnostics and tooling.
 */
export type RegistrationEvidence =
  | {
      ...
      /** Position of the registered identifier in the call */
      readonly span: SourceSpan;
    }
  | {
