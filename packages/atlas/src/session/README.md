...
source basis. Broader entity atom families and bundle admissions are warmed after manifest publication; bundle
admissions fill package-by-package so a cold evaluator pass does not make first startup unbounded. Cold startup is
singleflighted with an in-process pending promise plus an atomic
