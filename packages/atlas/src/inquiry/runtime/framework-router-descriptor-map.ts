...
export const ROUTER_FLOW_DESCRIPTORS = new Map<string, RouterFlowDescriptor>(
  [
    ...
    flowDescriptor("fragmentUrlParser.parse", 18, "url-parsing", "fragmentUrlParser.parse", "parses", "hash-fragment URL", "fragmentUrlParser.parse extracts the hash fragment as the router path before ParsedUrl._create processes query and fragment pieces."),
