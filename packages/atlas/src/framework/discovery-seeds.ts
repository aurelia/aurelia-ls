...
export const FRAMEWORK_DISCOVERY_SEED_ANCHORS: readonly FrameworkDiscoveryAnchor[] = [
  {
    ...
    source: { packageId: "runtime-html", symbolName: "Aurelia", declarationKind: "class", auLinkId: "runtime-html:Aurelia" },
  ...
  },
  {
    ...
    domains: [FrameworkSemanticDomain.Application, FrameworkSemanticDomain.Configuration],
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "aurelia", symbolName: "Aurelia", declarationKind: "class" },
  ...
  },
  {
    ...
    domains: [FrameworkSemanticDomain.DependencyInjection],
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "kernel", symbolName: "Container", declarationKind: "class", auLinkId: "kernel:Container" },
  ...
  },
  {
    ...
    domains: [FrameworkSemanticDomain.DependencyInjection],
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "kernel", symbolName: "IContainer", declarationKind: "interface", auLinkId: "kernel:IContainer" },
  ...
  },
  {
    ...
    domains: [FrameworkSemanticDomain.Compiler, FrameworkSemanticDomain.Resource, FrameworkSemanticDomain.Instruction],
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "template-compiler", symbolName: "TemplateCompiler", declarationKind: "class", auLinkId: "template-compiler:TemplateCompiler" },
  ...
  },
  {
    ...
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "runtime-html", symbolName: "Controller", declarationKind: "class" },
  ...
  },
  {
    ...
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "runtime-html", symbolName: "AppRoot", declarationKind: "class", auLinkId: "runtime-html:AppRoot" },
  ...
  },
  {
    ...
    domains: [FrameworkSemanticDomain.Resource, FrameworkSemanticDomain.Compiler, FrameworkSemanticDomain.Rendering],
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "runtime-html", symbolName: "CustomElementDefinition", declarationKind: "class", auLinkId: "runtime-html:CustomElementDefinition" },
  ...
  },
  {
    ...
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "template-compiler", symbolName: "HydrateElementInstruction", declarationKind: "interface" },
  ...
  },
  {
    ...
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "runtime", symbolName: "Scope", declarationKind: "class", auLinkId: "runtime:Scope" },
  ...
  },
  {
    ...
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "runtime", symbolName: "BindingContext", declarationKind: "class", auLinkId: "runtime:BindingContext" },
  ...
  },
  {
    ...
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "runtime", symbolName: "IObserverLocator", declarationKind: "variable" },
  ...
  },
  {
    ...
    domains: [FrameworkSemanticDomain.Reactivity, FrameworkSemanticDomain.Binding],
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "runtime", symbolName: "ObserverLocator", declarationKind: "class" },
  ...
  },
  {
    ...
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "runtime", symbolName: "INodeObserverLocator", declarationKind: "variable" },
    flows: [FrameworkFlowKind.ReactivitySetup, FrameworkFlowKind.Binding, FrameworkFlowKind.Lookup, FrameworkFlowKind.Registration],
    navigation: [NavigationRelation.SourceFor, NavigationRelation.TypeFactsFor, NavigationRelation.ReferencesOf, NavigationRelation.FrameworkFlowOf],
  ...
  },
  {
    ...
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "runtime-html", symbolName: "NodeObserverLocator", declarationKind: "class" },
  ...
  },
  {
    ...
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "runtime-html", symbolName: "AppTask", declarationKind: "variable" },
  ...
  },
  {
    ...
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "runtime-html", symbolName: "LifecycleHooks", declarationKind: "variable" },
  ...
  },
  {
    ...
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "router", symbolName: "Router", declarationKind: "class" },
  ...
  },
  {
    ...
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "router", symbolName: "RouterConfiguration", declarationKind: "variable" },
  ...
  },
  {
    ...
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "expression-parser", symbolName: "ExpressionParser", declarationKind: "class" },
  ...
  },
  {
    ...
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "expression-parser", symbolName: "ExpressionKind", declarationKind: "enum" },
  ...
  },
  {
    ...
    domains: [FrameworkSemanticDomain.Rendering, FrameworkSemanticDomain.Resource, FrameworkSemanticDomain.Lifecycle],
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "runtime-html", symbolName: "ViewFactory", declarationKind: "class" },
  ...
  },
  {
    ...
    phase: FrameworkDiscoveryPhase.Seed,
    source: { packageId: "runtime-html", symbolName: "Rendering", declarationKind: "class" },
