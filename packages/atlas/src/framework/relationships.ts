...
export const enum FrameworkRelationshipRelation {
  ...
  ConfiguresRouter = "configures-router",
  ConfiguresRoute = "configures-route",
  ...
  RunsRouterTransition = "runs-router-transition",
  RegistersViewport = "registers-viewport",
  UnregistersViewport = "unregisters-viewport",
  InvokesNavigation = "invokes-navigation",
  UpdatesNavigationModel = "updates-navigation-model",
