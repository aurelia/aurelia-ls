...
- router resource cursor/completion/diagnostic/refusal surfaces, router topology, route recognizer, route-resource
  instruction closure, routeable string resolution, router diagnostics, active-link state, static redirect controls, and
...
Current default output: 208 active assertions pass with 11 known gaps. The router-composition subdomain has 45 active
passes and no known gaps; the template-controller-scope subdomain has 40 active passes and 3 known gaps.
