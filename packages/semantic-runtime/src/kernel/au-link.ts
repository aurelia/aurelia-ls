...
export function auLink(id: 'runtime:ControlledComputedObserver'): ClassDecorator;
...
export function auLink(id: 'runtime:ProxyObservable'): ClassDecorator;
export function auLink(id: 'runtime:computed'): ClassDecorator;
export function auLink(id: 'runtime:ComputedMethodOptions'): ClassDecorator;
export function auLink(id: 'runtime:ComputedPropertyInfo'): ClassDecorator;
export function auLink(id: 'runtime:astBind'): ClassDecorator;
...
export function auLink(id: 'runtime-html:ComputedWatcher'): ClassDecorator;
export function auLink(id: 'runtime-html:ExpressionWatcher'): ClassDecorator;
...
export function auLink(id: 'runtime-html:AttributeNSAccessor'): ClassDecorator;
