...
export const enum DerivationRecordKind {
  ...
  /** A visible unresolved point that should survive into IDE and tooling projections. */
  OpenSeam = 'open-seam',
...
export const enum DerivationPhase {
  ...
  /** Indexing hint for rules that format stored facts into IDE, Atlas, tooling, AI, or diagnostic views. */
