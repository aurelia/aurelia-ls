...
import {
  ...
  semanticTemplateAnalysisBreadthSatisfies,
...
const resourceLocalTemplateAnalysis = {
  minimumTemplateAnalysisBreadth: SemanticTemplateAnalysisBreadth.ResourceLocal,
} as const;

const globallyResourceLocalTemplateAnalysis = {
  ...resourceLocalTemplateAnalysis,
  defaultTemplateAnalysisBreadth: SemanticTemplateAnalysisBreadth.ResourceLocal,
} as const;
...
const semanticAppQueryCatalogRows = [
  ...
  queryRow(SemanticAppQueryKind.TemplateDocumentOwnership, 'template', 'Complete exact component-template source-path set retained by converged custom-element definitions.', 'overview', globallyResourceLocalTemplateAnalysis),
  ...
  queryRow(SemanticAppQueryKind.AnalysisLimitations, 'diagnostics', 'Configured, adjudicated analysis limitations at unique authored product-pressure sites; raw seams remain available through the explicit open-seam audit queries.', 'row-table', { pagingKind: 'offset-cursor', supportsSourceFile: true, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.AppDiagnostics, 'diagnostics', 'Unified app diagnostics across TypeScript, modeled Aurelia issue lanes, and template diagnostics; optionally narrowed to one source file.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, supportsSourceFile: true, supportsDiagnosticProjection: true, materializationPolicy: 'query-type-projection', ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.AppDiagnosticSummary, 'diagnostics', 'Diagnostic clusters grouped by domain, kind, authority, severity, framework code, and owning query; explicit diagnostic projections include TypeScript diagnostics.', 'summary-row-table', { pagingKind: 'offset-cursor', supportsDetail: true, supportsSourceFile: true, supportsDiagnosticProjection: true, materializationPolicy: 'query-type-projection', ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.TypeScriptDiagnostics, 'diagnostics', 'Ordinary TypeScript project diagnostics from the semantic-runtime Program/tsconfig epoch.', 'row-table', { pagingKind: 'offset-cursor', supportsSourceFile: true, materializationPolicy: 'query-type-projection', ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.TypeScriptDiagnosticSummary, 'diagnostics', 'TypeScript diagnostic clusters grouped by compiler phase, category, code, severity, and TypeScript source label.', 'summary-row-table', { pagingKind: 'offset-cursor', supportsSourceFile: true, materializationPolicy: 'query-type-projection', ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.EvaluationIssues, 'evaluation', 'Static evaluator issues and unsupported runtime-dependent seams.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.ConfigurationIssues, 'configuration', 'Aurelia configuration and app-root issues projected from source and modeled registrations.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.DiIssues, 'di', 'Dependency-injection issues from the modeled container and registration world.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.ObservationIssues, 'observation', 'Observer/accessor and binding-observation issues from runtime binding setup.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.ComputedObservationDefinitions, 'observation', 'Valid @computed getter/method dependency declarations and their proxy/explicit observation mode.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.ComputedObserverSources, 'observation', 'Source-backed ComputedObserver and ControlledComputedObserver projection rows for authored getters.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.ComputedObserverObservedDependencies, 'observation', 'Getter-body and explicit-dependency reads collected by computed-observer source execution.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, observedDependencyLocusKinds: observedDependencyRowLocusKinds, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.RuntimeEffects, 'observation', 'Immutable construction-site plans for direct Observation.watch(...) and Observation.run(...) calls.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.RuntimeEffectObservedDependencies, 'observation', 'Expression, function-key, and synchronous RunEffect dependency reads collected by direct Observation source effects.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, observedDependencyLocusKinds: observedDependencyRowLocusKinds, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.ProxyObservableEscapes, 'observation', 'Source-level ProxyObservable.getRaw(...) and ProxyObservable.unwrap(...) escape calls.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.RuntimeExpressionAccessUses, 'observation', 'Owner-qualified authored expression accesses with exact operation slots, execution semantics, checker targets, and source loci.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingObservation, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.StateStores, 'state', 'Discovered state-store products and state ownership rows.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.StateGetterBindings, 'state', 'Source-level @fromState binding definitions with store resolution and selector/target type projection.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.StateIssues, 'state', 'State modeling issues and state-source diagnostics.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.I18nTranslationKeys, 'i18n', 'Static i18n translation keys admitted from I18nConfiguration init resources.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.I18nTranslationBindings, 'i18n', 'Rendered i18n TranslationBinding target groups and lifecycle issue counts.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingTargets, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.ValidationIssues, 'validation', 'Validation rule/model issues and validation behavior diagnostics.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.FetchClientIssues, 'fetch-client', 'Fetch client configuration and retry-interceptor diagnostics.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.DialogIssues, 'dialog', 'Dialog configuration, service, and child-resolver diagnostics.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.FrameworkCapabilityDemands, 'framework', 'Authored framework/plugin capability demands with registration admission, package/import availability evidence, and source-backed actionability posture.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, supportsSourceFile: true, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.FrameworkCapabilityExplanation, 'framework', 'Engine-authored causal explanation for the exact template-authored framework capability demand selected at a source cursor.', 'cursor-locus', { requiresCursor: true, ...resourceLocalTemplateAnalysis }),
  ...
  queryRow(SemanticAppQueryKind.ResourceInventory, 'resources', 'Project-selected runtime resource inventory with stable semantic identity, provenance, and exact declaration roles; bindable type surfaces are opt-in.', 'row-table', { pagingKind: 'offset-cursor', supportsTypeSurfaces: true, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.ResourceDefinitions, 'resources', 'Resolved Aurelia resource definitions visible to the app world.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, materializationPolicy: 'query-type-projection', ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.ResourceIssues, 'resources', 'Resource recognition, visibility, or materialization diagnostics.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.ResourceVisibility, 'resources', 'Resource visibility and scope rows for app and template compilation.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.TemplateResourceAvailability, 'resources', 'Effective runtime resources for one exact source/cursor-selected template compiler scope; bindable type surfaces are opt-in.', 'cursor-locus', { requiresCursor: true, supportsTypeSurfaces: true, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.ResourceAvailabilityExplanation, 'resources', 'Engine-authored causal explanation of canonical-name availability for one exact resource identity in one source/cursor-selected template compiler scope.', 'cursor-locus', { requiresCursor: true, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.TemplateCompilations, 'template', 'Compiled app-runtime and source-selected authoring template rows.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, ...globallyResourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.AttributeInterpretationExplanation, 'template', 'Engine-authored explanation of how Aurelia interpreted one exact top-level authored HTML attribute name, projected from compiler products without inferring omitted work.', 'cursor-locus', { requiresCursor: true, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.TemplateCompletions, 'template', 'Template completion candidates at a source cursor.', 'cursor-locus', { pagingKind: 'continuation-cursor', supportsDetail: true, requiresCursor: true, materializationPolicy: 'query-type-projection', minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingObservation, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.TemplateCursorInfo, 'template', 'Semantic template site, resource, bindable, member, and diagnostic context at a source cursor.', 'cursor-locus', { supportsDetail: true, requiresCursor: true, supportsDiagnosticProjection: true, materializationPolicy: 'query-type-projection', minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingObservation, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.TemplateReferences, 'template', 'Source-linked template references for the selected member at a source cursor.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, requiresCursor: true, materializationPolicy: 'query-type-projection', minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingObservation, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.TemplateRename, 'template', 'Conservative edit plan for renaming a source-backed template member, local, bindable, or resource name.', 'cursor-locus', { supportsDetail: true, requiresCursor: true, materializationPolicy: 'query-type-projection', minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingObservation, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.TemplateRenameFromTypeScript, 'template', 'Template-side edit plan for a TypeScript member rename initiated at a source cursor.', 'cursor-locus', { supportsDetail: true, requiresCursor: true, materializationPolicy: 'query-type-projection', minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingObservation, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.TemplateCodeActions, 'template', 'Conservative edit plans for runtime-owned template diagnostics at a source cursor.', 'cursor-locus', { supportsDetail: true, requiresCursor: true, supportsDiagnosticProjection: true, materializationPolicy: 'query-type-projection', minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingObservation, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.TemplateSemanticTokens, 'template', 'Source-linked template semantic tokens derived from compiled template and expression facts.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, supportsSourceFile: true, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.TemplateFoldingRanges, 'template', 'Source-linked foldable template regions derived from compiled HTML structure.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, supportsSourceFile: true, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.TemplateInlayHints, 'template', 'Source-linked template inlay hints derived from runtime binding facts.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, supportsSourceFile: true, minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingObservation, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.TemplateDiagnostics, 'template', 'Template diagnostics across app-runtime and source-selected authoring templates; diagnosticProjection controls answer-time TypeChecker work.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, supportsSourceFile: true, supportsDiagnosticProjection: true, materializationPolicy: 'query-type-projection', minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingObservation, ...resourceLocalTemplateAnalysis }),
  ...
  queryRow(SemanticAppQueryKind.TemplateContentProjections, 'rendering', 'Compiler provider sequences, runtime AuSlot view selection, and native Shadow DOM slot outlets.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true }),
  queryRow(SemanticAppQueryKind.BindingTargetAccesses, 'binding', 'Observer/accessor lookup selected for target-side binding access.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingTargets, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.TargetOperations, 'binding', 'Renderer-owned and binding-owned direct target operations.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingTargets, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.BindingTargetOperations, 'binding', 'Same projection as target operations for callers still using the older target-operation query name.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingTargets, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.BindingSourceOperations, 'binding', 'Source-side binding operations such as ref assignment and captured binding fan-out.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingTargets, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.BindingBehaviorApplications, 'binding', 'Materialized binding behavior applications after compiler resource scope and bind phase.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingTargets, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.ValueConverterApplications, 'binding', 'Materialized value converter applications over runtime binding expressions.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingObservation, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.BindingValueChannels, 'binding', 'Runtime value-channel shape selected for DOM/native/custom binding targets.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingObservation, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.BindingValueChannelSummary, 'binding', 'Grouped runtime value-channel and observer-coupling mechanisms for compact form/control explanation.', 'summary-row-table', { pagingKind: 'offset-cursor', minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingObservation, ...resourceLocalTemplateAnalysis }),
  queryRow(SemanticAppQueryKind.BindingDataFlows, 'binding', 'Source-to-target and target-to-source binding data-flow rows with TypeChecker pressure.', 'row-table', { pagingKind: 'offset-cursor', supportsDetail: true, minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingObservation, ...resourceLocalTemplateAnalysis }),
  ...
  queryRow(SemanticAppQueryKind.BindingDataFlowSummary, 'binding', 'Grouped binding data-flow directions, value channels, assignability, and writeback pressure.', 'summary-row-table', { pagingKind: 'offset-cursor', minimumAnalysisDepth: SemanticAppAnalysisDepth.BindingObservation, ...resourceLocalTemplateAnalysis }),
...
function appQueryCatalogDisplayText(
  ...
  const previewRows = rows.slice(0, 12).map((row) =>
    `${row.queryKind} [${row.resultRole}, depth=${row.minimumAnalysisDepth}, template=${row.minimumTemplateAnalysisBreadth}/${row.defaultTemplateAnalysisBreadth}, boundary=${row.runtimeBoundary}]`
  );
...
function queryRow(
  ...
  options: Partial<Pick<
    SemanticAppQueryCatalogRow,
    'runtimeBoundary' | 'materializationPolicy' | 'pagingKind' | 'minimumAnalysisDepth' | 'minimumTemplateAnalysisBreadth' | 'defaultTemplateAnalysisBreadth' | 'supportsDetail' | 'supportsSourceFile' | 'observedDependencyLocusKinds' | 'supportsOpenSeamFilters' | 'supportsDiagnosticProjection' | 'supportsTypeSurfaces' | 'supportsContinuationIntentFilter' | 'requiresCursor' | 'routeProductKind'
  >> = {},
): SemanticAppQueryCatalogRow {
  ...
  const minimumTemplateAnalysisBreadth = options.minimumTemplateAnalysisBreadth
    ?? SemanticTemplateAnalysisBreadth.AppAggregate;
  const defaultTemplateAnalysisBreadth = options.defaultTemplateAnalysisBreadth
    ?? SemanticTemplateAnalysisBreadth.AppAggregate;
  if (!semanticTemplateAnalysisBreadthSatisfies(
    defaultTemplateAnalysisBreadth,
    minimumTemplateAnalysisBreadth,
  )) {
    throw new Error(
      `App query '${queryKind}' default template analysis breadth '${defaultTemplateAnalysisBreadth}' `
        + `does not satisfy minimum '${minimumTemplateAnalysisBreadth}'.`,
    );
  }
  return {
    queryKind,
