...
/** Project @aurelia/fetch-client issue products into stable diagnostic rows. */
export function readFetchClientIssueRows(
  emission: AureliaAppWorldProjectEmission,
  store: KernelStore,
  handles: boolean,
): readonly SemanticFetchClientIssueRow[] {
  return emission.fetchClient.readIssues()
    .map((issue): SemanticFetchClientIssueRow => ({
