...
import { validateTemplateCompilerOccurrenceTargetRowMapping } from './template-compiler-target-row-mapping.js';
import {
...
export class TemplateCompilerOccurrenceTargetRowMapping {
  constructor(
    ...
    validateTemplateCompilerOccurrenceTargetRowMapping(draft, row, hydrateElement);
  }
}
