...
function controlElements(
  ...
  return [
    ...
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.TextInput, AppBuilderPartSourceLoweringSampleKind.WithOptionalSlots),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.EmailInput),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.EmailInput, AppBuilderPartSourceLoweringSampleKind.WithOptionalSlots),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.UrlInput),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.UrlInput, AppBuilderPartSourceLoweringSampleKind.WithOptionalSlots),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.TelInput),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.TelInput, AppBuilderPartSourceLoweringSampleKind.WithOptionalSlots),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.PasswordInput),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.PasswordInput, AppBuilderPartSourceLoweringSampleKind.WithOptionalSlots),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.SearchInput),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.SearchInput, AppBuilderPartSourceLoweringSampleKind.WithOptionalSlots),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.TimeInput),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.TimeInput, AppBuilderPartSourceLoweringSampleKind.WithOptionalSlots),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.DateTimeLocalInput),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.DateTimeLocalInput, AppBuilderPartSourceLoweringSampleKind.WithOptionalSlots),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.MonthInput),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.MonthInput, AppBuilderPartSourceLoweringSampleKind.WithOptionalSlots),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.WeekInput),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.WeekInput, AppBuilderPartSourceLoweringSampleKind.WithOptionalSlots),
    ...
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.DateInput, AppBuilderPartSourceLoweringSampleKind.WithOptionalSlots),
    ...
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.TextArea, AppBuilderPartSourceLoweringSampleKind.WithOptionalSlots),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.Checkbox),
    templateElement(fragments, AppBuilderPartKind.Control, AppBuilderControlId.Checkbox, AppBuilderPartSourceLoweringSampleKind.WithOptionalSlots),
