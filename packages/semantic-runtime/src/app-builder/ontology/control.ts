...
export enum AppBuilderControlPatternId {
  ...
  /** Native email input bound through core Aurelia value channels. */
  NativeEmailInput = 'native-email-input',
  /** Native URL input bound through core Aurelia value channels. */
  NativeUrlInput = 'native-url-input',
  /** Native telephone input bound through core Aurelia value channels. */
  NativeTelInput = 'native-tel-input',
  /** Native password input bound through core Aurelia value channels. */
  NativePasswordInput = 'native-password-input',
  /** Native search input bound through core Aurelia value channels. */
  NativeSearchInput = 'native-search-input',
  /** Native time input bound as a string through core Aurelia value channels. */
  NativeTimeInput = 'native-time-input',
  /** Native datetime-local input bound as a string through core Aurelia value channels. */
  NativeDateTimeLocalInput = 'native-datetime-local-input',
  /** Native month input bound as a string through core Aurelia value channels. */
  NativeMonthInput = 'native-month-input',
  /** Native week input bound as a string through core Aurelia value channels. */
  NativeWeekInput = 'native-week-input',
...
export const APP_BUILDER_CONTROL_PATTERN_ROWS: readonly AppBuilderControlPatternRow[] = [
  ...
  {
    id: AppBuilderControlPatternId.NativeEmailInput,
    manifestKind: AppBuilderControlManifestKind.ControlPattern,
    leafControlIds: [AppBuilderControlId.EmailInput],
    realizationPolicyIds: [AppBuilderControlRealizationPolicyId.InlineNative],
    title: 'Native Email Input',
    summary: 'Native email input for text fields with explicit email-address affordance; domain policy still owns persistence and validation strictness.',
    inputContractIds: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_CONTRACT_IDS,
    inputFacetSelections: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_SELECTIONS,
    status: appBuilderOntologyStatus({
      modeled: true,
  ...
  {
    id: AppBuilderControlPatternId.NativeUrlInput,
    manifestKind: AppBuilderControlManifestKind.ControlPattern,
    leafControlIds: [AppBuilderControlId.UrlInput],
    realizationPolicyIds: [AppBuilderControlRealizationPolicyId.InlineNative],
    title: 'Native URL Input',
    summary: 'Native URL input for text fields with explicit URL affordance; display/navigation semantics remain a separate pattern choice.',
    inputContractIds: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_CONTRACT_IDS,
    inputFacetSelections: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_SELECTIONS,
    status: appBuilderOntologyStatus({
      modeled: true,
  ...
  {
    id: AppBuilderControlPatternId.NativeTelInput,
    manifestKind: AppBuilderControlManifestKind.ControlPattern,
    leafControlIds: [AppBuilderControlId.TelInput],
    realizationPolicyIds: [AppBuilderControlRealizationPolicyId.InlineNative],
    title: 'Native Telephone Input',
    summary: 'Native telephone input for text fields with explicit telephone affordance; formatting policy stays caller/domain-owned.',
    inputContractIds: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_CONTRACT_IDS,
    inputFacetSelections: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_SELECTIONS,
    status: appBuilderOntologyStatus({
      modeled: true,
  ...
  {
    id: AppBuilderControlPatternId.NativePasswordInput,
    manifestKind: AppBuilderControlManifestKind.ControlPattern,
    leafControlIds: [AppBuilderControlId.PasswordInput],
    realizationPolicyIds: [AppBuilderControlRealizationPolicyId.InlineNative],
    title: 'Native Password Input',
    summary: 'Native password input for explicitly secret text fields; authentication/security workflow remains outside the control primitive.',
    inputContractIds: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_CONTRACT_IDS,
    inputFacetSelections: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_SELECTIONS,
    status: appBuilderOntologyStatus({
      modeled: true,
  ...
  {
    id: AppBuilderControlPatternId.NativeSearchInput,
    manifestKind: AppBuilderControlManifestKind.ControlPattern,
    leafControlIds: [AppBuilderControlId.SearchInput],
    realizationPolicyIds: [AppBuilderControlRealizationPolicyId.InlineNative],
    title: 'Native Search Input',
    summary: 'Native search input for explicit search/filter text fields; query semantics are supplied by collection/filter or caller policy.',
    inputContractIds: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_CONTRACT_IDS,
    inputFacetSelections: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_SELECTIONS,
    status: appBuilderOntologyStatus({
      modeled: true,
  ...
  {
    id: AppBuilderControlPatternId.NativeTimeInput,
    manifestKind: AppBuilderControlManifestKind.ControlPattern,
    leafControlIds: [AppBuilderControlId.TimeInput],
    realizationPolicyIds: [AppBuilderControlRealizationPolicyId.InlineNative],
    title: 'Native Time Input',
    summary: 'Native time input for explicit time-of-day text fields; app-builder treats the value as string transport, not a Date object.',
    inputContractIds: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_CONTRACT_IDS,
    inputFacetSelections: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_SELECTIONS,
    status: appBuilderOntologyStatus({
      modeled: true,
  ...
  {
    id: AppBuilderControlPatternId.NativeDateTimeLocalInput,
    manifestKind: AppBuilderControlManifestKind.ControlPattern,
    leafControlIds: [AppBuilderControlId.DateTimeLocalInput],
    realizationPolicyIds: [AppBuilderControlRealizationPolicyId.InlineNative],
    title: 'Native Date-Time Local Input',
    summary: 'Native datetime-local input for explicit local date-time text fields; app-builder treats the value as string transport, not a Date object.',
    inputContractIds: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_CONTRACT_IDS,
    inputFacetSelections: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_SELECTIONS,
    status: appBuilderOntologyStatus({
      modeled: true,
  ...
  {
    id: AppBuilderControlPatternId.NativeMonthInput,
    manifestKind: AppBuilderControlManifestKind.ControlPattern,
    leafControlIds: [AppBuilderControlId.MonthInput],
    realizationPolicyIds: [AppBuilderControlRealizationPolicyId.InlineNative],
    title: 'Native Month Input',
    summary: 'Native month input for explicit month text fields; app-builder treats the value as browser string transport.',
    inputContractIds: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_CONTRACT_IDS,
    inputFacetSelections: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_SELECTIONS,
    status: appBuilderOntologyStatus({
      modeled: true,
  ...
  {
    id: AppBuilderControlPatternId.NativeWeekInput,
    manifestKind: AppBuilderControlManifestKind.ControlPattern,
    leafControlIds: [AppBuilderControlId.WeekInput],
    realizationPolicyIds: [AppBuilderControlRealizationPolicyId.InlineNative],
    title: 'Native Week Input',
    summary: 'Native week input for explicit week text fields; app-builder treats the value as browser string transport.',
    inputContractIds: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_CONTRACT_IDS,
    inputFacetSelections: APP_BUILDER_NATIVE_FIELD_CONTROL_INPUT_SELECTIONS,
    status: appBuilderOntologyStatus({
      modeled: true,
