...
export const APP_BUILDER_DEFAULTING_CANDIDATE_POLICY_ROWS: readonly AppBuilderDefaultingCandidatePolicyRow[] = [
  ...
  defaultingCandidatePolicyRow(AppBuilderOntologyRowKind.ControlPattern, AppBuilderControlPatternId.NativeEmailInput, AppBuilderDefaultingCandidatePolicyScope.NativeControl, 'Native email input is the fallback after a text field is explicitly marked as an email-address affordance.'),
  defaultingCandidatePolicyRow(AppBuilderOntologyRowKind.ControlPattern, AppBuilderControlPatternId.NativeUrlInput, AppBuilderDefaultingCandidatePolicyScope.NativeControl, 'Native URL input is the fallback after a text field is explicitly marked as a URL affordance.'),
  defaultingCandidatePolicyRow(AppBuilderOntologyRowKind.ControlPattern, AppBuilderControlPatternId.NativeTelInput, AppBuilderDefaultingCandidatePolicyScope.NativeControl, 'Native telephone input is the fallback after a text field is explicitly marked as a telephone affordance.'),
  defaultingCandidatePolicyRow(AppBuilderOntologyRowKind.ControlPattern, AppBuilderControlPatternId.NativePasswordInput, AppBuilderDefaultingCandidatePolicyScope.NativeControl, 'Native password input is the fallback after a text field is explicitly marked as a secret/password affordance.'),
  defaultingCandidatePolicyRow(AppBuilderOntologyRowKind.ControlPattern, AppBuilderControlPatternId.NativeSearchInput, AppBuilderDefaultingCandidatePolicyScope.NativeControl, 'Native search input is the fallback after a text field is explicitly marked as a search/filter affordance.'),
  defaultingCandidatePolicyRow(AppBuilderOntologyRowKind.ControlPattern, AppBuilderControlPatternId.NativeTimeInput, AppBuilderDefaultingCandidatePolicyScope.NativeControl, 'Native time input is the fallback after a text field is explicitly marked as a time-of-day string affordance.'),
  defaultingCandidatePolicyRow(AppBuilderOntologyRowKind.ControlPattern, AppBuilderControlPatternId.NativeDateTimeLocalInput, AppBuilderDefaultingCandidatePolicyScope.NativeControl, 'Native datetime-local input is the fallback after a text field is explicitly marked as a local date-time string affordance.'),
  defaultingCandidatePolicyRow(AppBuilderOntologyRowKind.ControlPattern, AppBuilderControlPatternId.NativeMonthInput, AppBuilderDefaultingCandidatePolicyScope.NativeControl, 'Native month input is the fallback after a text field is explicitly marked as a month string affordance.'),
  defaultingCandidatePolicyRow(AppBuilderOntologyRowKind.ControlPattern, AppBuilderControlPatternId.NativeWeekInput, AppBuilderDefaultingCandidatePolicyScope.NativeControl, 'Native week input is the fallback after a text field is explicitly marked as a week string affordance.'),
  ...
  defaultingCandidatePolicyRow(AppBuilderOntologyRowKind.ControlPattern, AppBuilderControlPatternId.NativeDateInput, AppBuilderDefaultingCandidatePolicyScope.NativeControl, 'Native date input is the ordinary fallback for date-like fields when the app-builder boundary is a browser date string.'),
  ...
  defaultingCandidatePolicyRow(AppBuilderOntologyRowKind.PolicyAxis, AppBuilderPolicyAxisId.ValidationMechanism, AppBuilderDefaultingCandidatePolicyScope.PolicyAxis, 'Validation mechanism is a field/control policy axis that can receive caller or project defaults without converting native constraints into validation-library rules by implication.'),
