...
This directory stores regression contracts for code generated by the
legacy/internal app-builder. They support fixture verification and evidence
harvesting. Public MCP authoring uses Aurelia Patterns.
