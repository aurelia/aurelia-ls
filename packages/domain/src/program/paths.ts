...
import { normalizePathForId, toSourceFileId, type NormalizedPath, type SourceFileId } from "../compiler/model/index.js";

// Synthesis imports (via barrel)
import { computeOverlayBaseName } from "../compiler/synthesis/index.js";
