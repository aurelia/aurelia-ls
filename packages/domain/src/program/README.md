...
- `services.ts`
  Language/build facades. Diagnostics now merge compiler and overlay TypeScript diagnostics via provenance and surface host-agnostic spans; overlay/SSR access is wired; hover/defs/refs/completions/code actions/rename remain stubbed.
