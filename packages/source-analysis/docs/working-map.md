...
11. If the work is framework-aware and operationally aimed at the Aurelia framework repo itself, also read [aurelia/framework-export-integration-plan.md](./aurelia/framework-export-integration-plan.md).
12. If the work is in protocol or fixture derivation mode, also read
