...
import { findNodeBySpan, guessScriptKind, hasStaticModifier, readPropertyName, readReferenceSeed, readStringArrayValues, readStringLiteralValue, unwrapExpression } from '../analysis/ts-ast-helpers.js';
