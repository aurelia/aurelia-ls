...
function printHelp(): void {
  process.stdout.write(
    [
      ...
      '',
      'Modes:',
      '  refresh [deps|typerefs|exports|all] [--target <name>] [--repo <path>] [--out-dir <dir>] [--wait-ms <ms>]',
      '  deps <command> [args] [--target <name>] [--repo <path>] [--file path.json]',
      '  typerefs <command> [args] [--target <name>] [--repo <path>] [--file path.json]',
      '  exports <command> [args] [--target <name>] [--repo <path>] [--file path.json]',
      '',
