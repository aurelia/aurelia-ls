...
const settings_$au = {
  type: "custom-element",
  name: "settings",
  template: '<!--\n  Settings Page Template\n\n  Exercises:\n  - value.bind for text inputs\n  - value.bind for select dropdowns\n  - repeat.for for options\n  - click.trigger for buttons and toggles\n  - class.bind for active states\n  - if.bind for conditional display\n  - t="key" for labels\n-->\n\n<div class="page settings-page" data-testid="settings">\n  <!--au--><h2 t="settings.title"></h2>\n\n  <!-- Success message -->\n  <!--au--><!--au-start--><!--au-end-->\n\n  <!-- Profile Section -->\n  <section class="settings-section">\n    <div class="card">\n      <!--au--><h3 t="settings.sections.profile"></h3>\n\n      <div class="form-group">\n        <!--au--><label class="form-label" t="settings.profile.name"></label>\n        <!--au--><input type="text" class="form-input" data-testid="profile-name">\n      </div>\n\n      <div class="form-group">\n        <!--au--><label class="form-label" t="settings.profile.email"></label>\n        <!--au--><input type="email" class="form-input" data-testid="profile-email">\n      </div>\n\n      <div class="form-group">\n        <!--au--><label class="form-label" t="settings.profile.role"></label>\n        <!--au--><input type="text" class="form-input" disabled style="background: #f3f4f6;">\n      </div>\n\n      <!--au--><button class="btn btn-primary" data-testid="save-profile" t="settings.profile.save"></button>\n    </div>\n  </section>\n\n  <!-- Preferences Section -->\n  <section class="settings-section">\n    <div class="card">\n      <!--au--><h3 t="settings.sections.preferences"></h3>\n\n      <div class="form-group">\n        <!--au--><label class="form-label" t="settings.preferences.theme"></label>\n        <!--au--><select class="form-input" data-testid="theme-select">\n          <!--au--><!--au-start--><!--au-end-->\n        </select>\n      </div>\n\n      <div class="form-group">\n        <!--au--><label class="form-label" t="settings.preferences.language"></label>\n        <!--au--><select class="form-input" data-testid="language-select">\n          <!--au--><!--au-start--><!--au-end-->\n        </select>\n      </div>\n\n      <div class="form-group">\n        <!--au--><label class="form-label" t="settings.preferences.dateFormat"></label>\n        <!--au--><select class="form-input" data-testid="date-format-select">\n          <!--au--><!--au-start--><!--au-end-->\n        </select>\n      </div>\n\n      <!--au--><button class="btn btn-primary" data-testid="save-preferences" t="actions.save"></button>\n    </div>\n  </section>\n\n  <!-- Notifications Section -->\n  <section class="settings-section">\n    <div class="card">\n      <!--au--><h3 t="settings.sections.notifications"></h3>\n\n      <!-- Email notifications -->\n      <div class="form-group">\n        <!--au--><div data-testid="toggle-email">\n          <div class="toggle-switch"></div>\n          <div>\n            <!--au--><div style="font-weight: 500;" t="settings.notifications.email"></div>\n            <!--au--><div style="font-size: 0.875rem; color: #666;" t="settings.notifications.emailDesc"></div>\n          </div>\n        </div>\n      </div>\n\n      <!-- Browser notifications -->\n      <div class="form-group">\n        <!--au--><div data-testid="toggle-browser">\n          <div class="toggle-switch"></div>\n          <div>\n            <!--au--><div style="font-weight: 500;" t="settings.notifications.browser"></div>\n            <!--au--><div style="font-size: 0.875rem; color: #666;" t="settings.notifications.browserDesc"></div>\n          </div>\n        </div>\n      </div>\n\n      <!-- Assigned notifications -->\n      <div class="form-group">\n        <!--au--><div data-testid="toggle-assigned">\n          <div class="toggle-switch"></div>\n          <!--au--><div style="font-weight: 500;" t="settings.notifications.assigned"></div>\n        </div>\n      </div>\n\n      <!-- Mentioned notifications -->\n      <div class="form-group">\n        <!--au--><div data-testid="toggle-mentioned">\n          <div class="toggle-switch"></div>\n          <!--au--><div style="font-weight: 500;" t="settings.notifications.mentioned"></div>\n        </div>\n      </div>\n\n      <!-- Status change notifications -->\n      <div class="form-group">\n        <!--au--><div data-testid="toggle-status-change">\n          <div class="toggle-switch"></div>\n          <!--au--><div style="font-weight: 500;" t="settings.notifications.statusChange"></div>\n        </div>\n      </div>\n\n      <!--au--><button class="btn btn-primary" data-testid="save-notifications" t="actions.save"></button>\n    </div>\n  </section>\n</div>\n',
  instructions: [
    /* target 0 */
    [
      {
