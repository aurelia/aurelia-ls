/**
 * Sample Data for Issue Tracker
 *
 * Realistic sample data that exercises various template patterns:
 * - Users with different roles and online status
 * - Labels with various colors
 * - Issues in all workflow states
 * - Comments for discussion threads
 */

import type { User, Label, Issue, Comment } from "./types";
...
// =============================================================================
// Comments (shared across issues)
// =============================================================================

const commentsForAuth: Comment[] = [
  {
    id: "cmt-1",
    author: users[1]!,
...
// =============================================================================
// Issues - Covering all states and variations
// =============================================================================
...
export function getIssuesByAssignee(userId: string): Issue[] {
