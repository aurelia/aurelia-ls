...
<head>
  <meta charset="utf-8">
  <title>Kitchen Sink SSR Test</title>
  <style>
    .active { color: green; }
    .inactive { color: gray; }
    section { margin: 1rem 0; padding: 0.5rem; border: 1px solid #ddd; }
  </style>
...
export default defineConfig({
  ...
  plugins: [
    aurelia({
      ...
      ssr: {
        // Keep markers for debugging/testing - can verify they're in output
        stripMarkers: false,
        htmlShell: ssrShell,
        // Register router for SSR (provides 'load' attribute)
